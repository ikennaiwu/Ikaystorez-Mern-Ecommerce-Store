...
const categories = ["jeans", "t-shirts","Beach-Shirts" , "sneakers", "coperate-shoes","slides" ,"glasses", "joggers", "Wristwatches", "bags"];
...
const CreateProductForm = () => {
	...
	return (
		...
		>
			<h2 className='text-2xl font-semibold mb-6 text-eme
            rald-300'>Create New Product</h2>
